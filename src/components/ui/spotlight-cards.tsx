...
export default function SpotlightCards({
    ...
    return (
        <div
            className={cn(
                "relative w-full overflow-hidden rounded-2xl px-8 pt-9 pb-10 bg-transparent",
                className
            )}
        >
            ...
            <div className="relative mb-8 flex flex-col gap-1.5">
                <p className="font-semibold text-[10px] text-indigo-400 uppercase tracking-[0.22em]">
                    {eyebrow}
                </p>
