            ...
            >
                ...
                <defs>
                    <linearGradient id="sharedGradient" x1="0%" x2="100%" y1="0%" y2="0%">
                        <stop offset="0%" stopColor="rgba(167, 139, 250, 0.5)" /> {/* text-purple-400 */}
                        <stop offset="50%" stopColor="rgba(192, 132, 252, 0.5)" /> {/* text-purple-400 equivalent intermediate */}
                        <stop offset="100%" stopColor="rgba(129, 140, 248, 0.5)" />  {/* text-indigo-400 */}
                    </linearGradient>
                </defs>
