...
export default function BeamsBackground({
    ...
    const isDarkModeRef = useRef<boolean>(true); // Default to dark for this app
    ...
    useEffect(() => {
        ...
        const updateDarkMode = () => {
            // In StudentOS, it's always dark, but we can keep the logic
    ...
    return (
        <div
            className={cn(
                "absolute inset-0 w-full h-full overflow-hidden bg-[#0f1117] pointer-events-none -z-10",
                className
            )}
        >
            <canvas
            ...
            <motion.div
                ...
                className="absolute inset-0 bg-[#0f1117]/5"
                style={{
