...
function AnimatedInputOTPSlot({ index, className }: AnimatedInputOTPSlotProps) {
    ...
    return (
        <motion.div
            ...
            className={cn(
                "relative flex h-12 w-12 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-lg font-bold text-white shadow-xl outline-none transition-all data-[active=true]:border-indigo-500/50 data-[active=true]:ring-4 data-[active=true]:ring-indigo-500/20",
                className
            )}
