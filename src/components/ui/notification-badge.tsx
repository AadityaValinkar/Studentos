...
const NotificationBadge = ({
    ...
    const getBadgeClasses = () => {
        ...
        return cn(
            "h-[18px] min-w-[18px] px-1 text-[10px] font-bold leading-none",
            displayValue.length > 1 ? "rounded-full" : "rounded-full"
        );
    };
            ...
            {isVisible && (
                <motion.span
                    ...
                    className={cn(
                        ...
                        variant === "status" && "ring-2 ring-white dark:ring-gray-900 border border-white/10",
                        className
                    )}
                    exit={
                        shouldReduceMotion
